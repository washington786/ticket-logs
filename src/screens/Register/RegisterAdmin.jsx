                    ...
                    <div className="col-sm-12 pt-3">
                        <Card className="card p-0 mt-2">
                            <Card.Body>
                                ...
                                <h5 className="d-flex text-center justify-content-center align-items-center mt-2">Register As Admin</h5>
                                ...
                                <div className="form-con p-1 d-flex">
                                    ...
                                    <h4 className="text1">Already have an account?
                                        <Link to={"/loginAdmin"} id="link">Sign In</Link></h4>
                                </div>
                            </Card.Body>
                        </Card>
                    </div>
